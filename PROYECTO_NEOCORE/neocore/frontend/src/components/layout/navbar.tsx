        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href={`/${locale}`} className="flex items-center gap-2.5 group">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-lg font-black text-slate-900 tracking-tight">NeoCore</span>
              <span className="text-[10px] font-medium text-blue-600 tracking-widest uppercase">Salud &amp; Bienestar</span>
            </div>
          </Link>
