      ...
      <div className="container mx-auto px-4 -mt-8 md:-mt-16 mb-16 relative z-10">
        <div className="grid md:grid-cols-4 gap-6">
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">+34 910 555 730</p>
            <p className="text-gray-600 text-sm">Lun - Vie de 9:00 a 20:00</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">info@neocoree.xyz</p>
            <p className="text-gray-600 text-sm">Respondemos en menos de 24 h</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">Calle de la Salud, 28</p>
            <p className="text-gray-600">28013 Madrid</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {submitted && (
              <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3 text-green-700">
                ...
                <span>¡Mensaje enviado con éxito! Te hemos enviado un email de confirmación y te responderemos pronto.</span>
              </div>
            )}
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">+34 910 555 730</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">info@neocoree.xyz</p>
                  </div>
                </div>
              </div>
            </div>
