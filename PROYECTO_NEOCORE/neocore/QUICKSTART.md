...
| Email | Password | Rol |
|-------|----------|-----|
| admin@neocore.com | Admin.Demo.1234 | Admin |
| maria.garcia.fisio@neocore.com | Prof.Demo.1234 | Fisioterapeuta |
| (clientes generados por el seed) | Client.Demo.1234 | Cliente |
