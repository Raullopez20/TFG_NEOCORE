...
Define los endpoints relacionados con la autenticación y gestión de usuarios:
    ...
    - /users/me/export/           -> Exportación de datos personales (RGPD)
    - /users/me/delete/           -> Eliminación/anominización de cuenta (RGPD)
...
from .security_views import SecureLoginView, SecureLogoutView, SecureRegisterView, SecurePasswordResetView
...
urlpatterns = [
    ...
    path('password/reset/', SecurePasswordResetView.as_view(), name='rest_password_reset'),
